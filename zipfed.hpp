...
/**
 * Compares two Zipfed objects
 * @param pZip1 First Zipfed object
 * @param pZip2 Second Zipfed object
 * @return true if pZip1 is less than pZip2, else return false 
*/
  static bool comparator_function(Zipfed* pZip1, Zipfed* pZip2) {
    return pZip1->getCity() < pZip2->getCity();
  }
};
